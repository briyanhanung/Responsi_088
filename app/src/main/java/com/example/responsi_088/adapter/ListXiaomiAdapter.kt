package com.example.responsi_088.adapter
...
class ListSmartphoneAdapter (private val listSmartphone: ArrayList<Xiaomi>) : RecyclerView.Adapter<ListSmartphoneAdapter.SmartphoneViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SmartphoneViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.list_xiaomi, parent, false)
